...
<head>
    ...
    <meta name="description"
        content="AlterTrack centralise le suivi de vos stages et alternances. Importez vos données Excel, retrouvez chaque étudiant en un clic. Gratuit pour les établissements.">
...
<body class="font-sans antialiased text-gray-900 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <button @click="open = !open"
                    class="md:hidden p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
                ...
                <p class="text-xl text-gray-500 mb-8 max-w-lg leading-relaxed">
                    AlterTrack centralise le suivi de vos stages et alternances. Importez vos données Excel, retrouvez
                    chaque étudiant en un clic, et gardez le contrôle de toutes vos entreprises partenaires.
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-10">
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center justify-center gap-2 px-8 py-4 text-lg font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition">
                            Se connecter
                        </a>
                    @endauth
                </div>
                ...
                <div class="flex items-center gap-3">
                    <div class="flex -space-x-2">
                        ...
                        <div
                            ...
                            T</div>
                        <div
                            class="w-8 h-8 rounded-full bg-blue-400 border-2 border-white flex items-center justify-center text-white text-xs font-bold">
                            S</div>
                        <div
                            class="w-8 h-8 rounded-full bg-pink-400 border-2 border-white flex items-center justify-center text-white text-xs font-bold">
                            A</div>
                    </div>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="bg-gray-100 border-b border-gray-200 px-4 py-3 flex items-center gap-2">
                        ...
                        <div
                            class="ml-3 flex-1 bg-white rounded-md px-3 py-1 text-xs text-gray-400 border border-gray-200">
                            altertrack.app/dashboard</div>
                    </div>
                    {{-- Fake dashboard --}}
                        ...
                        <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
                            ...
                            <div class="divide-y divide-gray-50">
                                <div class="px-3 py-2 grid grid-cols-3 gap-2 items-center">
                                    ...
                                    <span
                                        class="inline-block text-xs px-1.5 py-0.5 bg-green-100 text-green-700 rounded font-medium w-fit">Alternance</span>
                                </div>
                                <div class="px-3 py-2 grid grid-cols-3 gap-2 items-center">
                                    <div class="text-xs text-gray-700 font-medium">Dupont A.</div>
                                    <div class="text-xs text-gray-500">Société Générale</div>
                                    <span
                                        class="inline-block text-xs px-1.5 py-0.5 bg-purple-100 text-purple-700 rounded font-medium w-fit">Stage</span>
                                </div>
                                <div class="px-3 py-2 grid grid-cols-3 gap-2 items-center">
                ...
                {{-- Floating badge --}}
                <div
                    class="absolute -bottom-4 -right-4 bg-white rounded-xl shadow-lg border border-gray-100 px-4 py-3 flex items-center gap-2">
    ...
    <section id="fonctionnalites" class="bg-white py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-lg text-gray-500 max-w-2xl mx-auto">Une solution pensée pour les équipes pédagogiques,
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="rounded-2xl bg-gray-50 border border-gray-100 p-8 hover:shadow-md transition">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Importez vos listes d'étudiants et d'entreprises
                        depuis vos fichiers Excel existants. Aucune ressaisie manuelle.</p>
                </div>
                ...
                <div class="rounded-2xl bg-gray-50 border border-gray-100 p-8 hover:shadow-md transition">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Retrouvez instantanément par type
                        (stage/alternance), technologie ou entreprise grâce à des filtres avec autocomplétion.</p>
                </div>
                ...
                <div class="rounded-2xl bg-gray-50 border border-gray-100 p-8 hover:shadow-md transition">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Carnet d'adresses complet de vos partenaires avec
                        historique de tous les accueils d'étudiants.</p>
                </div>
                ...
                <div class="rounded-2xl bg-gray-50 border border-gray-100 p-8 hover:shadow-md transition">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Technologies maîtrisées, professeur référent,
                        qualité du travail, période — toutes les infos en un seul endroit.</p>
                </div>
                ...
                <div class="rounded-2xl bg-gray-50 border border-gray-100 p-8 hover:shadow-md transition">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Accès réservé aux membres de votre établissement.
                        Données protégées, vérification d'email obligatoire.</p>
                </div>
    ...
    <section id="comment" class="bg-gray-50 py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-lg text-gray-500 max-w-xl mx-auto">Pas de formation requise, pas de configuration
                    complexe.</p>
            </div>
            ...
            <div class="relative grid lg:grid-cols-3 gap-10">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Inscription en 30 secondes avec votre email
                        professionnel. Vérification automatique pour sécuriser l'accès.</p>
                </div>
                ...
                <div class="text-center" style="grid-column: 2">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Glissez votre fichier Excel ou saisissez
                        manuellement vos entreprises et alternants. Quelques secondes suffisent.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Filtrez, consultez, modifiez à tout moment. Votre
                        tableau de bord centralise tout en temps réel.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">Ce qu'en disent nos utilisateurs
                </h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <p class="text-gray-600 italic text-sm leading-relaxed mb-6">"AlterTrack nous a fait gagner des
                        heures chaque semaine. L'import Excel est une vraie révolution pour notre équipe. On a enfin une
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <p class="text-gray-600 italic text-sm leading-relaxed mb-6">"Interface claire, prise en main
                        immédiate. Les filtres par technologie nous permettent de savoir en 2 clics quels étudiants ont
                        travaillé sur des projets React ou Python."</p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-purple-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
                            TB</div>
                        <div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <p class="text-gray-600 italic text-sm leading-relaxed mb-6">"Gratuit ET performant, c'est rare.
                        Nos données sont centralisées, nos équipes ont toutes le même niveau d'information. Je
                        recommande à tous les établissements."</p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-pink-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
                            SM</div>
                        <div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-data="{ open: null }" class="space-y-3">
                @php
                    $faqs = [
                        [
                            'q' => 'AlterTrack est-il vraiment gratuit ?',
                            'a' =>
                                'Oui, AlterTrack est entièrement gratuit pour tous les établissements d\'enseignement. Aucun abonnement, aucune carte de crédit, aucune limite cachée.',
                        ],
                        [
                            'q' => 'Puis-je importer mes données depuis Excel ?',
                            'a' =>
                                'Oui ! AlterTrack accepte les fichiers .xlsx pour l\'import en masse de vos entreprises et de vos dossiers d\'alternance. Des templates sont disponibles pour faciliter la mise en forme.',
                        ],
                        [
                            'q' => 'Mes données sont-elles sécurisées ?',
                            'a' =>
                                'Absolument. L\'accès est réservé aux utilisateurs vérifiés par email. Les connexions sont chiffrées et les données ne sont jamais partagées avec des tiers.',
                        ],
                        [
                            'q' => 'Combien d\'utilisateurs peut-on avoir par établissement ?',
                            'a' =>
                                'Il n\'y a pas de limite. Tous vos collaborateurs pédagogiques peuvent créer un compte et accéder aux données de l\'établissement.',
                        ],
                        [
                            'q' => 'Existe-t-il une application mobile ?',
                            'a' =>
                                'Pas encore d\'application native, mais AlterTrack est entièrement responsive et s\'utilise parfaitement depuis un smartphone ou une tablette.',
                        ],
                        [
                            'q' => 'Comment obtenir de l\'aide ?',
                            'a' =>
                                'Vous pouvez consulter la documentation ou contacter notre support par email. Nous répondons en général sous 24h ouvrées.',
                        ],
                    ];
                @endphp
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                        <button @click="open = open === {{ $i }} ? null : {{ $i }}"
                            ...
                            <svg class="w-5 h-5 text-gray-400 transition-transform duration-200 flex-shrink-0 ml-4"
                                :class="open === {{ $i }} ? 'rotate-45' : ''" fill="none"
