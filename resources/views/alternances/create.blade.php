<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-base text-gray-900 leading-tight">Ajouter une alternance</h2>
    </x-slot>

    <div class="py-6 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <x-breadcrumbs :links="['Ajouter une alternance' => '#']" />
                    ...
                    <div class="border-t border-gray-100 pt-5 mb-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nom_etudiant" id="nom_etudiant" value="{{ old('nom_etudiant') }}" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                            <div>
                                <label for="prenom_etudiant" class="block text-sm font-medium text-gray-700 mb-1">Prénom</label>
                                <input type="text" name="prenom_etudiant" id="prenom_etudiant" value="{{ old('prenom_etudiant') }}" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-5 mb-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="mois_annee" id="mois_annee" value="{{ old('mois_annee') }}" placeholder="09/2024" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                            <div>
                                <label for="duree" class="block text-sm font-medium text-gray-700 mb-1">Durée (mois)</label>
                                <input type="text" name="duree" id="duree" value="{{ old('duree') }}" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                            <div>
                                <label for="prof_referent" class="block text-sm font-medium text-gray-700 mb-1">Professeur référent</label>
                                <input type="text" name="prof_referent" id="prof_referent" value="{{ old('prof_referent') }}" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                            <div>
                                <label for="qualite_travail" class="block text-sm font-medium text-gray-700 mb-1">Qualité du travail</label>
                                <input type="text" name="qualite_travail" id="qualite_travail" value="{{ old('qualite_travail') }}" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                            <div>
                                ...
                                <input type="text" name="technos" id="technos" value="{{ old('technos') }}" placeholder="PHP,Laravel,Vue.js" required
                                       class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">
                            </div>
                        </div>
                        <div class="mt-4">
                            ...
                            <textarea name="descriptif" id="descriptif" rows="3" required
                                      class="block w-full border-gray-300 focus:border-violet-500 focus:ring-violet-500 rounded-lg text-sm">{{ old('descriptif') }}</textarea>
                        </div>
                    </div>
